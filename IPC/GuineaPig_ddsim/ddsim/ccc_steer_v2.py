...
SIM.crossingAngleBoost = 0.000 #Jim: should be zero for  C^3?
SIM.enableDetailedShowerMode = False #Jim: in detailed mode, for each hit also the position and pdg id of MCparticle is stored, see: https://github.com/iLCSoft/CLICPerformance/blob/487a80b1a75a0ca276f0d3657d5ab4d7c7c797d5/examples/lcio_geant4.py#L216
...
SIM.random.seed = 294531
#SIM.random.type = 'MTwistEngine'
