...
ddsim --compactFile ${K4GEO}/SiD/compact/SiD_o2_v04/SiD_o2_v04.xml \
        --outputFile ddsim_${collider}_seed_${seed}_${letter}.edm4hep.root \
...
mv ddsim_${collider}_seed_${seed}_${letter}.edm4hep.root output_new/${collider}/ddsim/ddsim_${collider}_seed_${seed}_${letter}.edm4hep.root
